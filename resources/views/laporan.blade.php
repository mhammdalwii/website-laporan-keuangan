...
<body class="bg-gray-100 dark:bg-[#0d1117] text-gray-800 dark:text-gray-200">
    ...
    <div class="container mx-auto p-4 sm:p-6 lg:p-8">
        <header class="mb-8 flex flex-col md:flex-row justify-between items-center fade-in gap-4">
             <a href="{{ route('dashboard') }}" class="bg-white dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 text-gray-700 dark:text-white text-sm font-bold py-2 px-4 rounded-md transition duration-300 flex items-center shadow-sm border border-gray-200 dark:border-transparent">
